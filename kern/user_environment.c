...
void * create_user_page_WS(unsigned int numOfElements)
{
	...
	uint32 *ptr_working_set=kmalloc(numOfElements*sizeof(struct WorkingSetElement));
	//change this "return" according to your answer
	return (void*)ptr_working_set;
}
...
void * create_user_directory()
{
	...
	uint32* ptr_user_dir = kmalloc(PAGE_SIZE);
	//change this "return" according to your answer
	return (void*)ptr_user_dir;
}
